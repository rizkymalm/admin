<?php
	...
	$mcImageManagerConfig['filesystem.path'] = 'mcith/'; // absolute or relative from this script path, optional.
	if ($_SESSION['level']=="admin"){
		$mcImageManagerConfig['filesystem.rootpath'] = 'admin'; // absolute or relative from this script path, required.
	}
	elseif ($_SESSION['level']=="user"){
		$mcImageManagerConfig['filesystem.rootpath'] = 'mcith/'; // absolute or relative from this script path, required.
	}
	
	$mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
	$mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
	$mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^admin$/i';
